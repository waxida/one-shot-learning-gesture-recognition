...
"""the path of train and valid set"""
training_datalist = './dataset_splits/train.txt'
testing_datalist = './dataset_splits/test.txt'
model_prefix='./'
...
if start_step>0:
  ...
  assign_params_my(sess, load_params[0:6], networks,0)
  assign_params_my(sess, load_params[6:12], networks,10)
  assign_params_my(sess, load_params[12:20], networks,20)
  assign_params_my(sess, load_params[20:34], networks,32)
  assign_params_my(sess, load_params[34:38], networks,50)
...
def training_data_read():
  ...
  for i in range(n_epoch):
      #tl.iterate.minibatches can generate a batch
